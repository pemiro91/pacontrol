# Generated by Django 4.0.2 on 2022-04-08 04:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha_venta', models.DateTimeField(verbose_name=datetime.datetime(2022, 4, 8, 0, 10, 4, 68208))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha', models.DateTimeField(verbose_name=datetime.datetime(2022, 4, 8, 0, 10, 4, 69208))),
                ('producto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hccontrolapp.producto')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha_gasto', models.DateTimeField(verbose_name=datetime.datetime(2022, 4, 8, 0, 10, 4, 68208))),
                ('usuario', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
