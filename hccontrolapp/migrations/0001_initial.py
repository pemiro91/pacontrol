# Generated by Django 4.0.2 on 2022-05-25 16:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha_venta', models.DateTimeField(verbose_name=datetime.datetime(2022, 5, 25, 12, 0, 17, 992473))),
                ('slug', models.SlugField(null=True, unique=True)),
                ('establecimiento', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='hccontrolapp.establecimiento')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha', models.DateTimeField(verbose_name=datetime.datetime(2022, 5, 25, 12, 0, 17, 994474))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha', models.DateTimeField(verbose_name=datetime.datetime(2022, 5, 25, 12, 0, 17, 993472))),
                ('establecimiento', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='hccontrolapp.establecimiento')),
                ('producto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hccontrolapp.producto')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha_gasto', models.DateTimeField(verbose_name=datetime.datetime(2022, 5, 25, 12, 0, 17, 991474))),
                ('establecimiento', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='hccontrolapp.establecimiento')),
                ('usuario', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
