# Generated by Django 4.0.2 on 2022-09-12 03:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha', models.DateTimeField(verbose_name=datetime.datetime(2022, 9, 11, 23, 38, 1, 138645))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha', models.DateTimeField(verbose_name=datetime.datetime(2022, 9, 11, 23, 38, 1, 137645))),
                ('establecimiento', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='hccontrolapp.establecimiento')),
                ('producto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hccontrolapp.producto')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha_gasto', models.DateTimeField(verbose_name=datetime.datetime(2022, 9, 11, 23, 38, 1, 135676))),
                ('establecimiento', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='hccontrolapp.establecimiento')),
                ('usuario', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
