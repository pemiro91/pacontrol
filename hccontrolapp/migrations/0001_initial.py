    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha_venta', models.DateTimeField(verbose_name=datetime.datetime(2022, 3, 24, 16, 48, 58, 879292))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha', models.DateTimeField(verbose_name=datetime.datetime(2022, 3, 24, 16, 48, 58, 880292))),
                ('producto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hccontrolapp.producto')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha_gasto', models.DateTimeField(verbose_name=datetime.datetime(2022, 3, 24, 16, 48, 58, 879292))),
                ('usuario', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
